<%@ Control Language="vb" AutoEventWireup="false" Codebehind="FinancialDocuments.ascx.vb" Inherits="TimeTrax.FinancialDocuments" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<tr> <!--Document Uploads-->
	<th class="th1" height="22">
		...
		<SPAN style="CURSOR: hand; TOP: 2px" onclick="ToggleDisplay(menu10a, menu10b);">Financial 
			Documents</SPAN>
		<BR clear="all">
	</th>
</tr>
<tr>
	<td>
		<SPAN id="menu10b" style="DISPLAY: block">
			<TABLE id="tblFinancialDocuments" width="100%" name="tblFinancialDocuments" class="t1" runat="server">
				<tr>
					<td>
