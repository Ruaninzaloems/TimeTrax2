	...
	//Create am instance of the calendar
...
function CalendarPopup() {
	...
	c.offsetX = -152;
	c.offsetY = 25;
	//Comment this out if you do not want the calander to hide when clicked on the page
	c.autoHide();
...
function CalendarPopup_select(inputobj, linkname, format) {
	//Set the div name if using a div for position
	if (this.type != "WINDOW") {
		this.divName = linkname;
	}
...
function CalendarPopup_getStyles() {
	...
	result += "A.textlink{height:20px;color:#000000;}\n";
	...
	result += "A.calothermonth{text-decoration:none;display:none;color:#808080;}\n";
...
function CalendarPopup_getCalendar() {
	...
	if (this.type == "WINDOW") {
		result += "<HTML><HEAD><TITLE>IM Calendar</TITLE>"+this.getStyles()+"</HEAD><BODY MARGINWIDTH=0 MARGINHEIGHT=0 TOPMARGIN=0 RIGHTMARGIN=0 LEFTMARGIN=0>\n";
		result += '<CENTER><TABLE WIDTH=100% BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=0>\n';
		}
	else {
		result += '<TABLE style="POSITION:relative;left:-150;top:25;BACKGROUND-COLOR: white;layer-background-color: white" WIDTH=144 BORDER=1 BORDERWIDTH=1 BORDERCOLOR="#808080" CELLSPACING=0 CELLPADDING=1>\n';
