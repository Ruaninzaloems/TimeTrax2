		...
		for (var i = 1; i <= itemcount; i++)
			{
				...
				arrData = document.Form1["ucOrders_hidBoxorder_"+i].value.split(",");
...
function loadTasks()
{
	...
	try {
		...
		{
			//Add a new line in the dynamic add
			arrData = document.Form1["ucOrders_hidBoxtask_"+i].value.split(",");
...
function validateBudgetAllocated(oSrc, args) 
{
	...
	//alert(document.all.ucOrders_txtHidTaskOrderItemDesc.value);
	//alert(document.all.ucOrders_task_orderitem.value);
