...
#Region " PAGE LOAD "
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            Session("Page") = ""
            Session("PageTitle") = Session("AppName") & " - Approval (Project TakeOn)"
            ViewState("ProjectID") = Request.QueryString("ProjID")
            ucProjInfo.ProjectID = ViewState("ProjectID")
            ucProjInfo.blnShowSummaries = False
    ...
    Private Sub LoadProjectApprovals()
        ...
        arParms2(1) = New SqlParameter("@ApprovalType", "1")
...
#Region " SUBMIT DETAILS "
    ...
    Private Sub btnApprove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnApprove.Click
        ...
        Else
            ' Update the Approval Stage to the next stage
    ...
    Private Sub btnReject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        ' Change the Project Status to TakeOn
    ...
    Private Sub WriteApprovalToDb(ByVal Approval As Int16)
        ...
        End If
        DAL.InsertApproval(Common.ApprovalType.ProjectTakeOn, User.Identity.Name, ViewState("ProjectID"), Comment, Approval)
    ...
    Private Sub BuildAndSendEmail(ByVal UserID As Integer, ByVal Type As String)
        ...
        If MailTo <> "" Then
            Select Case Type
                Case "Reject"
                    ' Send email to Team Leader to notify Project Take on has been rejected
                    strBody = "<font face=Arial size=2>The following project has been rejected for take on:" & vbCrLf & _
                ...
                Case "Approve"
                    ...
                    strBody = "<font face=Arial size=2>The following project is waiting for your approval: " & vbCrLf & _
                              "<br><br><b>Project Code: </b>" & ViewState("ProjectCode") & vbCrLf & _
                              "<br><b>Project  Name: </b>" & ViewState("ProjectName") & "</font>"

                    Subject = "Project Awaiting Approval:" & ViewState("ProjectCode") & " - " & ViewState("ProjectName")
            End Select
