<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ExpenseItems.aspx.vb" Inherits="TimeTrax.ExpenseTypes"%>
...
<body>
	...
	<form id="Form1" method="post" runat="server">
		...
		<table class="t4" width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<th class="th">
					Manage Constants - Expense Items</th>
			</tr>
			<tr>
				<td valign="top">
									...
									<table class="t3" cellSpacing="2" cellPadding="2" width="100%" align="center" border="0">
										<tr>
											<td class="td" vAlign="top" align="center">
												<asp:datalist id="dlconstant" runat="server" width="100%">
													<HeaderTemplate>
														<tr>
															<th class="th1" width="80%">
																Expense Item</th>
													...
													<ItemTemplate>
														<tr>
															<td class="td1" width="80%">
																...
																<asp:TextBox ID="txtconstant" Runat="server" CssClass="input" text='<%# DataBinder.Eval(Container.DataItem, "ConstantName") %>' Width="90%">
																</asp:TextBox>
															</td>
															<td class="td1" width="10%" align="center">
																<asp:TextBox ID="txtamt" Runat="server" CssClass="inputR" text='<%# DataBinder.Eval(Container.DataItem, "Amount") %>' Width="50">
																</asp:TextBox>
															</td>
															<td class="td1" width="5%" align="center">
																<asp:CheckBox ID="chkFixed" runat="server" cssclass="cell" Checked='<%# DataBinder.Eval(Container.DataItem, "Fixed") %>'>
																</asp:CheckBox>
															</td>
															<td class="td1" width="5%" align="center">
												...
												<div id="tblDynAdd" runat="server">
													<TABLE id="tblItem" style="DISPLAY: block" cellSpacing="0" cellPadding="0" width="100%"
														...
														<TR id="rowItemDefaultA" style="DISPLAY: none" vAlign="top">
															...
															<TD class="td" width="74%">
																<asp:textbox id="txtconstant_" runat="server" CssClass="input" Width="80%"></asp:textbox>
															</TD>
															<td class="td" width="10%" align="center"><asp:TextBox ID="txtamt_" runat="server" cssclass="inputR" Width="50"></asp:TextBox></td>
															<td class="td" width="5%" align="center"><asp:CheckBox ID="chkfixed_" runat="server" cssclass="td" Checked="False"></asp:CheckBox></td>
															<td class="td" width="5%" align="center"><asp:CheckBox ID="chkenabled_" runat="server" cssclass="td" Checked="True"></asp:CheckBox></td>
														</TR>
													</TABLE>
													<TABLE width="100%" align="center" border="0">
														<TR>
															<TD class="td" colSpan="2"><INPUT type="hidden" name="item_list"><INPUT id="LoadCount" type="hidden" name="LoadCount" runat="server">
																...
																<CENTER>Add Budget Items by clicking the Add button.&nbsp;&nbsp;<IMG style="CURSOR: hand" onclick="addFormSection('Item', document.Form1);" alt="Add New Row"
