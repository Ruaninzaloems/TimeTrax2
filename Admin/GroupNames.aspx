...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="GroupNames.aspx.vb" Inherits="TimeTrax.GroupNames"%>
<body>
													...
													<TABLE width="100%" align="center" border="0">
														<TR>
															<TD class="td" colSpan="2"><INPUT type="hidden" name="item_list"><INPUT id="LoadCount" type="hidden" name="LoadCount" runat="server">
																...
																<CENTER>Add Groups by clicking the Add button.&nbsp;&nbsp;<IMG style="CURSOR: hand" onclick="addFormSection('Item', document.Form1);" alt="Add New Row"
