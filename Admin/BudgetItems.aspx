<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BudgetItems.aspx.vb" Inherits="TimeTrax.BudgetItems"%>
  ...
  <im:Header id="ucHeader" runat="server"></im:Header>
    <form id="Form1" method="post" runat="server">
		...
		<table class="t4" width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<th class="th">Manage Constants - Budget Items</th>
			</tr>
			<tr>
				<td valign="top">
									...
									<table class="t3" cellSpacing="2" cellPadding="2" width="100%" align="center" border="0">
										<tr>
											<td class="td" vAlign="top" align="center">
												<asp:datalist id="dlconstant" runat="server" width="600" BorderWidth="0">
													<HeaderTemplate>
														<tr>
															<th class="th1" width="95%">Order Item</th>
												...
												<div id="tblDynAdd" runat="server">
													<TABLE id="tblItem" style="DISPLAY: block" cellSpacing="0" cellPadding="0" width="600"
														...
														<TR id="rowItemDefaultA" style="DISPLAY: none" vAlign="top">
															...
															<TD class="td" width="520">
																<asp:textbox id="txtconstant_" runat="server" Width="385" ReadOnly="False" CssClass="input" TextMode="SingleLine"	Rows="1"></asp:textbox>
															</TD>
															<td class="td" width="70" align="center"><asp:CheckBox ID="chkenabled_" runat="server" cssclass="td" Checked="True"></asp:CheckBox></td>
														</TR>
													</TABLE>
