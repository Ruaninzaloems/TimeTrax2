<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ApprovalTypes.aspx.vb" Inherits="TimeTrax.ApprovalTypes"%>
  ...
  <im:Header id="ucHeader" runat="server"></im:Header>
    <form id="Form1" method="post" runat="server">
		...
		<table class="t4" width="100%" cellspacing="0" cellpadding="0" border="0">
			<tr>
				<th class="th">Manage Constants - Approval Types</th>
			</tr>
			<tr>
				<td valign="top">
										...
										<tr>
											<td class="td" vAlign="top" align="center">
												<asp:datalist id="dlconstant" runat="server" width="600">
													<HeaderTemplate>
														<tr>
															<th class="th1" width="95%">Approval Type</th>
													...
													<TABLE width="100%" align="center" border="0">
														<TR>
															<TD class="td" colSpan="2"><INPUT type="hidden" name="item_list"><INPUT id="LoadCount" type="hidden" name="LoadCount" runat="server">
																...
																<CENTER>Add Types by clicking the Add button.&nbsp;&nbsp;<IMG style="CURSOR: hand" onclick="addFormSection('Item', document.Form1);" alt="Add New Row"
